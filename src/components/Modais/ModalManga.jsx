...
import "./Modais.css";
export default function Modal({visible , onClose, mangaData}){
    ...
    return (
        <div id="modal-blur" onClick={handleOnClose} className="modal-blur">
            <div className="modal-box">
                <img src={mangaData.banner} className="w-80 h-full bg-gray-500 rounded-xl flex-shrink-0"/>
                <div className="h-full flex flex-col">
                    <p className="modal-title">{mangaData.title}</p>
                    {/* <p className="modal-subtitle">Naoko Takeuch</p> */}
                    <p className="modal-content"> {mangaData.description}</p>
                    ...
                    <div className="mt-auto flex justify-end">
                        <Link to={'/comic/'+mangaData.id} className="manga-read-button">Ler</Link>
                    </div>
                </div>
            </div>
        </div>
